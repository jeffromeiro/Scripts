...
Linux: PGPASSWORD=senha psql -h api-proposta-prd.ceip7fi02lcw.sa-east-1.rds.amazonaws.com -d postgres -U usuario -E
Windows: set PGPASSWORD=senha 
		 psql -h api-proposta-prd.ceip7fi02lcw.sa-east-1.rds.amazonaws.com -d postgres -U usuario -E
...
- '\d table_name : List columns from a specific table:
- `\l`: List databases
- `\dy`: List events
- `\df`: List functions
- `\di`: List indexes
